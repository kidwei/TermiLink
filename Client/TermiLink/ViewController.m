...
- (void)setupUI {
    ...
    // 服务器 IP cell
    UITableViewCell *serverCell = [[UITableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:nil];
    ...
    // 状态 section
    UITableViewCell *statusCell = [[UITableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:nil];
